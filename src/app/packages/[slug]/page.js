...
const fleet = [
  {
    ...
    desc: "Experience the breathtaking beauty of Kashmir with serene valleys and lakes.",
    ...
    amenities: [
      { icon: "bluetooth", label: "Hotel Stay" },
      { icon: "music", label: "Meals Included" },
      { icon: "camera", label: "Sightseeing" },
      { icon: "thermometer", label: "AC Transport" },
    ],
    ...
    about: "Enjoy Kashmir's valleys, lakes, and mountains with a perfectly curated travel experience.",
  },

  {
    ...
    desc: "Explore the scenic beauty of Shimla and Manali with snow-capped mountains.",
    ...
    about: "Enjoy snow mountains, valleys, and adventure activities in Shimla and Manali.",
  },

  {
    slug: "sikkim",
    title: "Sikkim Darjeeling Tour",
    tagline: "Eastern Beauty",
    desc: "Discover the charm of Sikkim and Darjeeling with tea gardens and mountains.",
    ...
    amenities: [
      ...
      { icon: "music", label: "Meals Included" },
      { icon: "camera", label: "Sightseeing" },
      { icon: "thermometer", label: "Transport" },
    ],
    ...
    about: "Explore tea gardens, monasteries, and scenic views in Sikkim & Darjeeling.",
  },

  {
    ...
    desc: "Enjoy crystal clear beaches and water sports in Andaman.",
    ...
    amenities: [
      { icon: "bluetooth", label: "Resort Stay" },
      { icon: "music", label: "Meals Included" },
    ...
    about: "Relax on beautiful beaches and enjoy water sports in Andaman islands.",
  },

  {
    ...
    desc: "Experience royal palaces, deserts, and cultural heritage.",
    ...
    about: "Discover forts, palaces, and desert culture of Rajasthan.",
  },

  {
    ...
    title: "Goa Tour",
    tagline: "Beach Vibes",
    desc: "Enjoy beaches, nightlife, and water activities in Goa.",
    ...
    about: "Experience vibrant nightlife and relaxing beaches in Goa.",
  },

  {
    ...
    desc: "Explore Delhi, Agra, and Jaipur in one amazing journey.",
    ...
    about: "Discover India’s iconic cities: Delhi, Agra, and Jaipur.",
  }
];
const policies = [
